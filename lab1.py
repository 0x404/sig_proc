...
figure()
suptitle(u'Sygnały o zgodnej amplitudzie i częstotliwości, przesunięte w fazie o $\\pi$', fontsize=16)
multiplot([sinus_1, sinus_2], [sinus_sum], [sinus_mult])
pdf_pages.savefig()
...
findings = '''
W przypadku, gdy oba sygnały mają taką samą częstotliwość i fazę, amplituda sumy tych sygnałów jest sumą amplitud sygnałów składowych; gdy bierzemy pod uwagę iloczyn, maksymalne odchylenie od stanu zero to iloczyn amplitud sygnałów źródłowych. Warto również zauważyć brak wartości ujemnych na wykresie iloczynu sygnałów.
